...
const Player: React.FC<IPlayerProps> = ({currentSong,
	...
	const skipTrackHandler = async (direction: string) => {
		let currentIndex = songs.findIndex((song: { id: number; }) => song.id === currentSong.id);
	...
	const activeLibraryHandler = (newSong: { id: any; }) => {
		const newSongs = songs.map((song: { id: any; }) => {
	...
	return (
		<PlayerContainer>
			<TimeControlContainer>
				...
				<Track as="div" currentSong={currentSong}>
					<Input
